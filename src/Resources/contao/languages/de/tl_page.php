 ...
 * Reference
 */
$GLOBALS['TL_LANG']['tl_page']['page_info_filter'] = 'Zeige Infos:';

/**
 * Page info - options
 */
$GLOBALS['TL_LANG']['tl_page']['page_info_options']['id']                      = 'ID';
$GLOBALS['TL_LANG']['tl_page']['page_info_options']['tstamp']                  = 'Änderungsdatum';
...
$GLOBALS['TL_LANG']['tl_page']['page_info_options']['layoutSet']               =
    $GLOBALS['TL_LANG']['tl_page']['layout'][0] . ' gesetzt';
...
$GLOBALS['TL_LANG']['tl_page']['page_info_options']['search']                  = 'Suche';
$GLOBALS['TL_LANG']['tl_page']['page_info_options']['show']                    = 'Sichtbar';
$GLOBALS['TL_LANG']['tl_page']['page_info_options']['changelanguage_fallback'] =
    '[Sprachenwechsler] - Seite in Hauptsprache';
$GLOBALS['TL_LANG']['tl_page']['page_info_options']['version']                 = 'Version (letzte)';
